	...
	<form name="RecordForm" id="RecordForm" method="post" action="">
		...
		?>
            <tr>
            	...
            	<td align="left">
                	<?php if($Web->f('Type')==1) { ?><input type="hidden" name="TableIDs[]" value="<?php echo $Web->f('TableID'); ?>" /><input type="text" name="Settings[]" class="Textfield" value="<?php echo $Web->f('Data'); ?>" /><?php } else if($Web->f('Type')==2) { ?>

...
<table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:10px;">
	<tr>
    	<td align="left" width="50%"><h1><?php echo $Content["Title"]; ?> Images</h1></td>
        <td align="right" width="25%">
        
    <input type="hidden" value="<?php echo $_REQUEST['RecordID'] ?>" name="RecordID" />
    <input type="file" name="images[]" id="imgs" multiple class="Button" >
   </td>
    <td align="right"> <input type="submit" name="submit" value="UPLOAD" class="Button"/></td>

        
        <?php /*?><a onclick="UploadImageWOCrop('<?php echo PRODUCT_IMAGE_GALLERY_WIDTH; ?>', '<?php echo PRODUCT_IMAGE_GALLERY_HEIGHT; ?>', '<?php echo IMAGES_FOLDER; ?>', '<?php echo IMAGE_TYPE_PRODUCT_GALLERY; ?>', '<?php echo $RecordID; ?>', '', '');">Upload Image</a><?php */?>
...
<table width="100%" cellpadding="5" cellspacing="0" border="1" bordercolor="60c2e9" style="border-collapse:collapse;">
    ...
    <tr id="Data_<?php echo $Web->f('TableID'); ?>">
    	<td align="left"><img src="../<?php echo IMAGES_FOLDER."/".$Web->f('FileName'); ?>" alt="" height="50" width="50"/></td>
...
<table width="100%" cellpadding="5" cellspacing="0" border="1" bordercolor="60c2e9" style="border-collapse:collapse;">
    <tr class="Data-Heading">
      <td width="5%" align="center">S.No</td>
        ...
        <td width="10%" align="center">Best Sell</td>

...
$mcFileManagerConfig['filesystem.path'] = $_SERVER["../../../upload_files/"].PATH_UPLOAD_FOLDER; // absolute or relative from this script path.
$mcFileManagerConfig['filesystem.rootpath'] = $_SERVER["../../../upload_files/"].PATH_UPLOAD_FOLDER; // absolute or relative from this script path.

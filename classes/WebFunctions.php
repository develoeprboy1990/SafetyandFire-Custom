...
class WebFunctions extends DBMySql
{
	...
	function getLinkFieldData($StringField, $WhereField, $WhereValue,$WhereField1, $WhereValue1, $TableName)
	{
		$this->query("Select $StringField from $TableName where $WhereField='".$WhereValue."' AND $WhereField1='".$WhereValue1."'");

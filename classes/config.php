...
else
{
	...
	define("WEB_URL", "https://safetyandfire.co.za/");
	define("ADMIN_URL", WEB_URL."admin/");
    define("DATABASE_NAME","safandfieq_db1");
    define("DATABASE_USER","safandfieq_1");
    define("DATABASE_PASSWORD","vGiUrK16W4HPCCMM4K98");
	define("DATABASE_HOST","sql6.jnb1.host-h.net");
}
